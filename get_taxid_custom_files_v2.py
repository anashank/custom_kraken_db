...
root_children, superkingdom_children,phylum_children, classs_children, order_children, family_children, genus_children, species_children = {'root':[]}, {}, {}, {}, {}, {}, {}, {}
...
children_list = [superkingdom_children,phylum_children, classs_children, order_children, family_children, genus_children, species_children]
...
superkingdom_children,phylum_children, classs_children, order_children, family_children, genus_children, species_children = children_list
...
for a in root_children['root']:
  ...
  for b in superkingdom_children[a]:
    ...
    # for c in kingdom_children[b]:
      ...
      for d in phylum_children[b]:
        taxid_list.append(classs[d]+[d, rank_names[2]])
        for e in classs_children[d]:
          taxid_list.append(order[e]+[e, rank_names[3]])
          for f in order_children[e]:
            taxid_list.append(family[f]+[f, rank_names[4]])
            for g in family_children[f]:
              taxid_list.append(genus[g]+[g, rank_names[5]])
              for h in genus_children[g]:
                taxid_list.append(species[h]+[h, rank_names[6]])
                # for i in species_children[h]:
                #   taxid_list.append(strain[i]+[i, rank_names[8]])
